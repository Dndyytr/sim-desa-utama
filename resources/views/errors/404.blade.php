...
<div class="bg-primary size-full flex flex-col items-center justify-between p-2 gap-2">
    <div class="flex w-full flex-col my-auto items-center justify-center gap-2">
        <div
            class="w-full xl:max-w-[30%] -mb-4 b400:-mb-6 lg:-mb-8 lg:max-w-[33%] md:max-w-[40%] max-w-[70%] h-max mx-auto drop-shadow-[-2px_10px_15px_rgba(0,0,0,0.7)]">
            <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 500 500">
                ...
                <g id="freepik--Shadow--inject-34">
                    <ellipse id="freepik--path--inject-34" cx="250" cy="416.24" rx="193.89" ry="11.32"
                        style="fill:#f5f5f5"></ellipse>
                </g>
                <g id="freepik--oops--inject-34">
                    <path
                ...
                <g id="freepik--error-404--inject-34">
                    <path
                    ...
                    <path
                        ...
                        style="fill:#FFC700;opacity:0.30000000000000004"></path>
                    <path
                ...
                <g id="freepik--robot-parts--inject-34">
                    <path
                    ...
                    <polygon
                        ...
                        style="fill:#FFC700"></polygon>
                    <path d="M419.9,412.59a1.82,1.82,0,1,0,0-3.63l3.42-.68.91,2.76-1.52,2.33Z" style="fill:#FFC700">
                    </path>
                    <path
        ...
        <div class="t-size6 flex flex-col gap-0.5">
            <h1 class="text-white text-center font-semibold text-[1.2em] uppercase">
                Page Not Found</h1>
            <p class="text-center text-secondary font-semibold">Halaman yang Anda cari tidak ditemukan.</p>
        </div>
