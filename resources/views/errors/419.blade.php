...
<div class="bg-primary size-full flex flex-col items-center justify-between p-2 gap-2">
    <div class="flex w-full flex-col my-auto items-center justify-center gap-2">
        <div
            class="w-full xl:max-w-[30%] lg:max-w-[33%] md:max-w-[40%] max-w-[70%] -mb-4 b400:-mb-6 lg:-mb-8 h-max mx-auto drop-shadow-[-2px_10px_15px_rgba(0,0,0,0.7)]">
            <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 500 500">
                <g id="freepik--background-complete--inject-211">
                    ...
                    <rect x="164.11" y="88.33" width="30.94" height="20.45" style="fill:#e0e0e0"></rect>
                    <rect x="164.11" y="88.33" width="31" height="3.36" style="fill:#f0f0f0"></rect>
                    <rect x="96.5" y="164.16" width="30.94" height="20.45" style="fill:#e0e0e0"></rect>
                    <rect x="96.5" y="164.16" width="31" height="3.36" style="fill:#f0f0f0"></rect>
                    <rect x="92.22" y="309.72" width="30.94" height="20.45" style="fill:#e0e0e0"></rect>
                    <rect x="92.22" y="309.72" width="31" height="3.36" style="fill:#f0f0f0"></rect>
                    <rect x="330.44" y="257.02" width="30.94" height="20.45" style="fill:#e0e0e0"></rect>
                    <rect x="330.44" y="257.02" width="31" height="3.36" style="fill:#f0f0f0"></rect>
                    <rect x="398.25" y="283.55" width="30.94" height="20.45" style="fill:#e0e0e0"></rect>
                    <rect x="398.25" y="283.55" width="31" height="3.36" style="fill:#f0f0f0"></rect>
                    <rect x="386.87" y="130.76" width="30.94" height="20.45" style="fill:#e0e0e0"></rect>
                    <rect x="386.87" y="130.76" width="31" height="3.36" style="fill:#f0f0f0"></rect>
                </g>
                <g id="freepik--Shadow--inject-211">
                    <ellipse id="freepik--path--inject-211" cx="250" cy="416.24" rx="193.89" ry="11.32"
                        style="fill:#f5f5f5"></ellipse>
                </g>
                <g id="freepik--speech-bubble--inject-211">
                    <path
                ...
                <g id="freepik--Character--inject-211">
                    ...
                    <path d="M173.68,175.65c0,2.8-2.17,7.88-5.17,5S173.73,170.84,173.68,175.65Z" style="fill:#263238">
                    </path>
                    <path
                    ...
                    <path d="M168.71,181.8c-.24.5-.16,1,.17,1.19s.8-.14,1-.64.15-1-.18-1.2S168.94,181.29,168.71,181.8Z"
                        style="fill:#263238"></path>
                    <path d="M166.76,181.22a19.25,19.25,0,0,0,.52,5.31,3.33,3.33,0,0,1-2.61-.7Z" style="fill:#de5753">
                    </path>
                    <path
                    ...
                    <path
                        ...
                        style="fill:#fff"></path>
                    <path d="M186.06,261.64l6.74,2.15-5.37,5.72s-5.9-2.28-4.6-5.27Z" style="fill:#e4897b"></path>
                    ...
                    <path
                        ...
                        style="opacity:0.2"></path>
                    <path d="M128.81,226.31l5.24-4.71,2.59,8.53s-5.34,3-7.24.32Z" style="fill:#e4897b"></path>
                ...
                <g id="freepik--Device--inject-211">
                    ...
                    <polygon points="289.07 344.53 290.56 353.2 294.74 377.6 342.93 369.63 332.67 344.23 289.07 344.53"
                    ...
                    <path
                        ...
                        style="isolation:isolate;opacity:0.2"></path>
                    <rect x="203.77" y="225.02" width="198.6" height="131.77" style="fill:#263238"></rect>
                    <rect x="203.77" y="225.02" width="198.6" height="10.11" style="fill:#FFC700"></rect>
                    ...
                    <path d="M381.42,230.44A2.47,2.47,0,1,1,379,228,2.48,2.48,0,0,1,381.42,230.44Z"
                        style="opacity:0.2"></path>
                    <rect x="203.77" y="235.18" width="198.6" height="34.21" style="fill:#fff;opacity:0.4"></rect>
                    <polygon points="208.32 236.7 203.77 244.85 203.77 236.7 208.32 236.7" style="fill:#263238">
                    </polygon>
                    ...
                    <polygon
                        ...
                        style="fill:#263238"></polygon>
                    <polygon points="402.37 259.96 402.37 267.98 397.9 267.98 402.37 259.96" style="fill:#263238">
                    </polygon>
                    <rect x="203.77" y="322.45" width="198.6" height="34.21" style="fill:#fff;opacity:0.4"></rect>
                    <polygon points="208.32 324.25 203.77 332.33 203.77 324.25 208.32 324.25" style="fill:#263238">
                    </polygon>
                    <polygon
                    ...
                    <polygon
                        ...
                        style="fill:#263238"></polygon>
                    <polygon points="402.37 347.31 402.37 355.27 397.9 355.27 402.37 347.31" style="fill:#263238">
                    </polygon>
                    <path d="M270.17,301v2.85h-13.7V285.58h13.34v2.84h-9.94v4.75h8.82V296h-8.82v5Z" style="fill:#fff">
                    </path>
                    <path
                    ...
                    <path
                        ...
                        style="fill:#fff;opacity:0.4"></path>
                    <path d="M224.47,225c27.46,27.51,98,88.73,177.9,84.21V225Z" style="fill:#fff;opacity:0.1"></path>
                    <path
                ...
                <g id="freepik--tool-box--inject-211">
                    <path
                    ...
                    <polygon points="422.95 377.6 414.7 399.39 379.53 399.39 387.78 377.6 422.95 377.6"
                        style="isolation:isolate;opacity:0.4"></polygon>
                    ...
                    <rect x="353.88" y="399.39" width="60.82" height="17.76"
                        transform="translate(768.58 816.54) rotate(180)" style="fill:#263238"></rect>
                    <rect x="353.88" y="399.39" width="60.82" height="17.76"
                        transform="translate(768.58 816.54) rotate(180)" style="fill:#fff;opacity:0.2"></rect>
                    <rect x="360.48" y="391.14" width="55.87" height="2.81"
                        transform="translate(776.83 785.1) rotate(180)" style="fill:#263238"></rect>
                    <rect x="360.48" y="391.14" width="55.87" height="2.81"
                        transform="translate(776.83 785.1) rotate(180)" style="fill:#fff;opacity:0.2"></rect>
                    <rect x="394.9" y="391.14" width="21.45" height="2.81"
                        transform="translate(811.25 785.1) rotate(180)" style="isolation:isolate;opacity:0.2"></rect>
                    <rect x="363.77" y="382.9" width="55.87" height="2.81"
                        transform="translate(783.42 768.6) rotate(180)" style="fill:#263238"></rect>
                    <rect x="363.77" y="382.9" width="55.87" height="2.81"
                        transform="translate(783.42 768.6) rotate(180)" style="fill:#fff;opacity:0.2"></rect>
                    <rect x="398.2" y="382.9" width="21.45" height="2.81"
                        transform="translate(817.85 768.6) rotate(180)" style="isolation:isolate;opacity:0.2"></rect>
                    <rect x="390.78" y="399.39" width="23.92" height="17.76"
                        transform="translate(805.48 816.54) rotate(180)" style="isolation:isolate;opacity:0.2"></rect>
                </g>
            </svg>
        ...
        <div class="t-size6 flex flex-col gap-0.5">
            <h1 class="text-white text-center font-semibold text-[1.2em] uppercase">
                Page Expired</h1>
            <p class="text-center text-secondary font-semibold">Halaman telah kedaluwarsa, silakan muat ulang dan coba
                lagi.</p>
        </div>
