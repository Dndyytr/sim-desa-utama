    ...
    <div class="flex w-full flex-col gap-2 my-auto items-center justify-center">
        <div
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 500 500">
                <g id="freepik--Floor--inject-5">
                    <ellipse id="freepik--floor--inject-5" cx="250" cy="384.61" rx="209.73" ry="94.79"
                        style="fill:#f5f5f5"></ellipse>
                </g>
                <g id="freepik--Shadows--inject-5">
                    <ellipse id="freepik--Shadow--inject-5" cx="352.36" cy="395.73" rx="56.05" ry="32.36"
                ...
                <g id="freepik--error-403--inject-5">
                ...
                <g id="freepik--Character--inject-5">
                    <g id="freepik--character--inject-5">
                        ...
                        <path
                            ...
                            style="opacity:0.1"></path>
                        <path d="M409.89,228.59a14.48,14.48,0,0,1,.31-8.69s-2.06,2-1.62,8.72Z" style="fill:#FFC700">
                        </path>
                        ...
                        <path
                            ...
                            style="opacity:0.1"></path>
                        <path d="M314.94,269.69c2.84.18,7.89-.62,10-2,0,0-3.68,1.63-10.19.7Z" style="fill:#FFC700">
                        </path>
        ...
        <div class="t-size6 flex flex-col gap-0.5">
            <h1 class="text-white text-center font-semibold text-[1.2em] uppercase">
                Forbidden</h1>
            <p class="text-center text-secondary font-semibold">Pengguna tidak memiliki izin yang sesuai.</p>
        </div>


        <a class="bg-secondary t-size3 px-2.5 py-1.5 bp360:px-3 bp360:py-2 font-medium hover:bg-yellow-300 active:bg-yellow-300 transition-all duration-300 ease-in-out cursor-pointer hover:shadow-[0_2px_7px_rgba(0,0,0,0.5)] active:shadow-none hover:-translate-y-0.5 active:translate-y-0.5 text-white rounded-md"
