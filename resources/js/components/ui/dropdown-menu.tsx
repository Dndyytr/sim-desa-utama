    ...
    return (
        <DropdownMenuPrimitive.Portal>
            <DropdownMenuPrimitive.Content
                ...
                collisionPadding={10}
                className={cn(
                    'z-50 min-w-32 overflow-hidden rounded-md bg-popover p-1 text-popover-foreground shadow-md transition-all duration-300 ease-in-out data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=closed]:zoom-out-95 data-[state=open]:animate-in data-[state=open]:fade-in-0 data-[state=open]:zoom-in-95',
                    className,
                )}
                {...props}
            />
...
function DropdownMenuSeparator({
    ...
    return (
        <DropdownMenuPrimitive.Separator
            ...
            className={cn('-mx-1 my-1 h-[1.5px] bg-border', className)}
            {...props}
        />
    );
}
