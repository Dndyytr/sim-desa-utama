...
export default function RolesEdit({
    ...
    const initialPermissionIds = rolePermissions.map(Number);
    ...
    type UpdateRoleArg = Parameters<typeof update>[0];

    const updateRoleArg = {
        id: role.id,
    } as unknown as UpdateRoleArg;
                        ...
                        <>
                            <div className="flex h-full flex-col gap-4 2xl:gap-5.5">
                                ...
                                <div className="grid grid-cols-1 gap-2 sm:gap-2.5 md:grid-cols-[1fr_0.6fr]">
                                    ...
                                    <div className="flex flex-col gap-2 rounded-lg bg-yellow-50 p-2.5 shadow-[0_10px_20px_0px_rgba(0,0,0,0.2)] bp360:gap-2.25 bp360:p-3 bp400:gap-2.5 bp400:p-3.25 sm:gap-2.75 md:gap-3 md:p-3.5 lg:p-4 xl:p-4.5 2xl:p-5">
                                        <div className="inline-flex items-center gap-2 md:gap-2.5 lg:gap-2.75 xl:gap-3">
                                    ...
                                    <div className="flex flex-wrap gap-2">
                                        {parentFeatures.map((feature) => {
                                            ...
                                            return (
                                                <div
                                                    key={feature.id}
                                                    className="inline-flex flex-col flex-wrap gap-2 overflow-hidden rounded-md bg-white p-2 shadow-[0_0_3.5px_0_rgba(0,0,0,0.2)] bp400:flex-row md:p-2.5 xl:p-3 2xl:p-3.5"
                                                >
