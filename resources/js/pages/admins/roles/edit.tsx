                                    ...
                                    <div className="flex flex-wrap gap-2">
                                        {filteredFeatures.map((feature) => {
                                            ...
                                            return (
                                                <div
                                                    key={feature.id}
                                                    className="inline-flex flex-col gap-2 overflow-hidden rounded-md bg-white p-2 shadow-[0_0_3.5px_0_rgba(0,0,0,0.2)] bp400:flex-row md:p-2.5 xl:p-3 2xl:p-3.5"
                                                >
