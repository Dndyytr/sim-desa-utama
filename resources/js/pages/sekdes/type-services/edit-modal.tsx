...
import { update } from '@/routes/type-services';
...
interface EditModalTypeServiceProps {
    typeService: TypeService;
}

export default function EditModalTypeService({
    typeService,
}: EditModalTypeServiceProps) {
    type UpdateTypeServiceArg = Parameters<typeof update.form.put>[0];

    const updateTypeServiceArg = {
        type_service: typeService.id,
    } as unknown as UpdateTypeServiceArg;

    const [isOpen, setIsOpen] = useState(false);
    const [selectedStatus, setSelectedStatus] = useState<string>(
        typeService.is_active ? '1' : '0',
    );
        ...
        <Dialog open={isOpen} onOpenChange={setIsOpen}>
            ...
            <DialogContent>
                ...
                <DialogHeader className="t-size2">
                    ...
                    <DialogDescription>
                        Perbarui formulir untuk mengubah data jenis layanan.
                    </DialogDescription>
                </DialogHeader>

                <Form
                    {...update.form.patch(updateTypeServiceArg)}
                    transform={(data) => ({
                        ...data,
                        is_active: selectedStatus === '1',
                    })}
                    options={{
                        ...
                        <>
                            <div className="flex flex-col gap-1.5 bp360:gap-1.75 bp400:gap-2">
                                ...
                                <Input
                                    ...
                                    type="text"
                                    name="service_code"
                                    defaultValue={typeService.service_code}
                            ...
                            <div className="grid gap-1.5 bp360:gap-1.75 bp400:gap-2 sm:grid-cols-2">
                                ...
                                <div className="flex flex-col gap-1.5 bp360:gap-1.75 bp400:gap-2">
                                    ...
                                    <Input
                                        ...
                                        type="text"
                                        name="service_name"
                                        defaultValue={typeService.service_name}
                            ...
                            <div className="flex flex-col gap-1.5 bp360:gap-1.75 bp400:gap-2">
                                ...
                                <Textarea
                                    ...
                                    tabIndex={3}
                                    rows={5}
                                    defaultValue={typeService.description || ''}
