...
export default function ServicesShow({
    ...
    // In React/Inertia, relationship assignedTo is snake-cased to assigned_to
    const currentAssignedTo = service.assigned_to;

    const disposeForm = useForm({
        assigned_to: currentAssignedTo?.id ? String(currentAssignedTo.id) : '',
        notes: service.notes || '',
    });

    const handleDisposeSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        disposeForm.patch(route('services.disposition', service.id), {
            onSuccess: () => {
        ...
        <>
            ...
            <div className="flex h-full flex-col gap-2 px-2 py-2 bp360:gap-2.25 bp360:px-2.25 bp360:py-2.25 bp400:gap-2.5 bp400:px-2.5 bp400:py-2.5 md:gap-2.75 md:px-3 md:py-2.25 lg:gap-3 lg:px-3.5 lg:py-2.5 xl:gap-3.5 xl:px-4 xl:py-3 2xl:gap-4 2xl:px-4.5 2xl:py-3.5">
                ...
                <div className="t-size2 font-medium text-stone-500">
                    Disposisi Layanan &gt; Detail Layanan &gt;{' '}
                        ...
                        <div className="flex flex-col gap-2 rounded-lg bg-white p-2.5 shadow-[0_10px_20px_0px_rgba(0,0,0,0.2)] bp360:gap-2.25 bp360:p-3 bp400:gap-2.5 bp400:p-3.25 sm:gap-2.75 md:gap-3 md:p-3.5 lg:p-4 xl:p-4.5 2xl:p-5">
                            ...
                            <div className="flex flex-col gap-2 bp400:gap-2.5">
                                ...
                                {service.notes && (
                                    <div className="mt-1 flex flex-col gap-1">
                                        <span className="t-size2 font-semibold text-stone-500">
                                            Catatan / Instruksi Disposisi Sekdes
                                        </span>
            ...
            <Dialog open={isDisposeOpen} onOpenChange={setIsDisposeOpen}>
                <DialogContent className="sm:max-w-120">
                    <DialogHeader className="t-size2">
                        ...
                        <DialogDescription>
                            Tentukan petugas (Kasi/Kaur) yang akan memproses
                            berkas layanan ini.
                        </DialogDescription>
                    </DialogHeader>
                    ...
                    >
                        ...
                        <div className="flex flex-col gap-1.5">
                            ...
                            <Select
                                value={disposeForm.data.assigned_to}
                                onValueChange={(value) =>
                                    disposeForm.setData('assigned_to', value)
                                }
                            >
                            ...
                            <InputError
                                message={disposeForm.errors.assigned_to}
                            />
                        </div>
                        ...
                        <div className="flex flex-col gap-1.5">
                            ...
                            <Textarea
                                id="dispose_notes"
                                value={disposeForm.data.notes}
                                onChange={(e) =>
                                    disposeForm.setData('notes', e.target.value)
                                }
                                placeholder="Masukkan instruksi khusus untuk pengerjaan layanan ini..."
                                rows={4}
                                className="t-size3"
                            />
                            <InputError message={disposeForm.errors.notes} />
                        </div>
